...
void calc() {
    ...
    sharpgp2y10_config.calcVoltage = (sharpgp2y10_config.volMeasured * (sharpgp2y10_config.vccVol / 4024));   //calc real Voltage
    ...
    {
    	sharpgp2y10_config.dustDensity = 0.01;
    }
 }
